...
class Fetch:
    ...
    def __init__(self, bp=None, dtype=None, save_loc=None):
        self.save_loc = save_loc
        print(bp.url, bp.query, bp.request)
        for req in bp.request:
            print(req)
        ...
        # elif dtype == 'JSON':
        #     self.baseurl = base_products['base_url']
        #     self.query = base_products['query']

        #     for feature in base_products['request']:
